...
import { EMPTY_ARR, EMPTY_OBJ, NO, NOOP, camelize, canSetValueDirectly, extend, extend as extend$1, getEscapedCssVarName, getGlobalThis, getSequence, hasOwn, includeBooleanAttr, invokeArrayFns, isArray, isForwardedSlot, isFunction, isModelListener, isObject, isOn, isPlainObject, isPromise, isReservedProp, isSpecialBooleanAttr, isString, isSymbol, looseEqual, normalizeClass, normalizeCssVarValue, normalizeStyle, parseStringStyle, remove as remove$1, slotInheritsFallback, slotNotifiesBoundary, stringifyStyle, toDisplayString } from "@vue/shared";
...
var SlotFragment = class extends DynamicFragment {
	constructor(flags = 0, adoptAnchor) {
		super(1156, !!(process.env.NODE_ENV !== "production") ? "slot" : void 0, false, false, false, void 0, adoptAnchor);
		this.disposed = false;
...
function defineVaporAsyncComponent(source) {
	...
	return /* @__PURE__ */ defineVaporComponent({
		...
		__asyncHydrate(el, instance, hydrate) {
			...
			const prev = setCurrentInstance(instance);
			try {
				const frag = new DynamicFragment(0, !!(process.env.NODE_ENV !== "production") ? "async component" : void 0, false, false);
				frag.nodes = nodes;
				instance.block = frag;
			} finally {
				restoreCurrentInstance(prev);
		...
		setup() {
			...
			if (isHydrating$1 && isDynamicFragment(placeholder)) {
				...
				frag.nodes = EMPTY_BLOCK;
				locateHydrationNode();
			} else frag = new DynamicFragment(0, !!(process.env.NODE_ENV !== "production") ? "async component" : void 0);
	...
	initChildren() {
		...
		try {
			...
			renderEffect(() => runWithFragmentCtxOnly(this, () => {
				...
				const scope = this.scope = new EffectScope$1();
